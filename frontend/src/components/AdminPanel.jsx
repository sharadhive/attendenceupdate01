...
function AdminPanel() {
  ...
  const login = async () => {
    try {
      const res = await axios.post('https://attendenceupdate01.onrender.com/api/admin/login', {
        name: branchName,
        password,
      });
  ...
  const fetchEmployees = async (branchNameToUse, tokenToUse) => {
    try {
      const res = await axios.get(`https://attendenceupdate01.onrender.com/api/admin/employees/${branchNameToUse}`, {
  ...
  const createEmployee = async () => {
    try {
      await axios.post('https://attendenceupdate01.onrender.com/api/admin/create-employee', {
        email: newEmpEmail,
  ...
  const viewAttendance = async (empId) => {
    ...
    try {
      const res = await axios.get(`https://attendenceupdate01.onrender.com/api/admin/attendance/${empId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const updateAttendance = async (empId, recordId, status, remarks) => {
    try {
      await axios.put(`https://attendenceupdate01.onrender.com/api/admin/attendance/${recordId}`, {
        status,
        remarks,
      }, {
        headers: { Authorization: `Bearer ${token}` },
